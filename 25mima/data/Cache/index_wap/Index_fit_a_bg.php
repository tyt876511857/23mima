...
<html>
	...
	<section class="ui-row ui-whitespace">
		<div class="ui-border">
			...
			<div class="ui-btn-wrap">
				<button class="ui-btn" onclick="location.href='/index/Index/fit_z/id/<?php echo $id; ?>';">
					检测结果解释
				</button>
	...
	<section class="ui-row ui-whitespace">
	<a href="/index/Index/baogao1/id/<?php echo $id; ?>/key/<?php if(isset($v['id'])){echo $v['id'];} ?>/f/<?php if(isset($v['fs'])){echo $v['fs'];} ?>">
