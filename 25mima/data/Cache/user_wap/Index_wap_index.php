...
<html>
	...
	<head>
		...
		.ui-list li a{padding:5px 30px 5px 0;height:35px;line-height:35px;}
			...
			<div class="ui-row-flex ui-row-flex-ver" style="height:2rem;">
				<div class="ui-col ui-col-2" style="background:url('/public/wap1/user/user.jpg') no-repeat #000;background-size:100%;">
					<div class="ui-row-flex ui-whitespace ui-row-flex-ver" style="height: 1.3rem;padding:0.5em;">
						...
						<div class="ui-col" style="text-align:center;color:#fff !important;"><?php if(isset($_SESSION['user_userid'])){echo $_SESSION['user_userid'];} ?></div>
					</div>
				</div>
				<div class="ui-col" style="padding:10px 0">
					<ul class="ui-tiled">
						<li><a href="<?php echo U('Indent/index/i_type/0','user') ?>"><i class="iconfont3 icon-fahuo"></i><div>未付款</div></a></li>
						<li><a href="<?php echo U('Indent/index/i_type/1','user') ?>"><i class="iconfont3 icon-order"></i><div>已付款</div></a></li>
						<li><a href="<?php echo U('Indent/index/i_type/2','user') ?>"><i class="iconfont3 icon-yifahuoshouji"></i><div>已发货</div></a></li>
						<li><a href="<?php echo U('Index/mytuoye','user') ?>"><i class="iconfont3 icon-hezi01"></i><div>采样盒</div></a></li>
						<li><a href="<?php echo U('Index/mybaogao','user') ?>"><i class="iconfont3 icon-baogao"></i><div>我的报告</div></a></li>
					</ul>
