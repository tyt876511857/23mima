...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/public/wap1/css/light.css" />
		...
		<style>
			...
			p{text-align:left;padding:0 10px;}
			/*#595856*/
		</style>
		<script>
			$(function() {
	...
	<body >
		...
		<section class="ui-container" style="margin-bottom: 40px;">
			<div class="ui-row ui-whitespace" style="background: #1FADDD;position: relative;z-index: 90;">
				...
				<div class="ui-form-item ui-border-b" style=" position:relative;width: 130px;height:30px;background:#FFFFFF;border-radius: 10px;float: right;margin:6px;line-height: 30px;">
			...
			<div class="ui-row report_con">
				...
				<div class="ui-row" style="width: 50%;margin: 0 auto;text-align: center;">
					<div class="power" style="background:url(/public/wap1/images/xuetiao<?php if(isset($_GET['f'])){echo $_GET['f'];} ?>.png) no-repeat center top;height:27px;"></div>
				...
				<div class="ui-row ui-whitespace">
					...
					<div class="ui-row ui-whitespace" style="text-align: center;border-top: 2px solid #0079FF;background: #DCF3F9;padding: 10px 0;font-size:0.8em">
						...
						<div class="ui-row ui-row-flex">
							...
							<div class="ui-col ui-col-2">
								<!-- <div class="lv<?php echo $r; ?>" style="margin:0 auto;"></div> -->
				...
				<ul class="ui-list ui-list-text ui-list-active ui-list-cover user_link">
					<li class="ui-border-t u_l_li">
						<i class="title kexue"></i><span style="margin-left:0">基因解读</span><i class="iconfont direction_right">&#xe662;</i>
					</li>
					<div class="ui-row ui-whitespace hide" style="text-align: center;border-top: 2px solid #0079FF;background: #FFFFFF;padding: 10px 0;margin-bottom: 30px;">
						<p><?php if(isset($zheye['content1'])){echo $zheye['content1'];} ?></p>
					</div>
					<li class="ui-border-t u_l_li">
						<i class="title story"></i><span style="margin-left:0">基因小故事</span><i class="iconfont direction_right">&#xe662;</i>
					</li>
					<div class="ui-row ui-whitespace hide" style="text-align: center;border-top: 2px solid #0079FF;background: #FFFFFF;padding: 10px 0;margin-bottom: 30px;">
...
if (!shareData) {
    var shareData = {
        ...
        link: 'http://23mima.com/index/Index/fenxiang1/type/1/id/'+<?php if(isset($_GET['id'])){echo $_GET['id'];} ?>+'/key/'+<?php if(isset($_GET['key'])){echo $_GET['key'];} ?>+'/f/'+<?php if(isset($_GET['f'])){echo $_GET['f'];} ?>,
