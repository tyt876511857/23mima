...
<html>
	...
	<body style="background: #FFFFFF;">
		<section class="ui-container ui-center login">
			...
			<form action="<?php echo U('Index/update_pwd') ?>" method="post" name="">
				<div class="login_con">
					<h5>您好，<?php if(isset($_SESSION['user_userid'])){echo $_SESSION['user_userid'];} ?></h5>
					<!-- <div class="login_name">
						<span class="login_name_icon"><img src="/public/wap1/images/login02.png"></span>
						<input type="password" name="mima" placeholder="请输入旧密码"  />
					</div> -->
					<div class="login_name">
						<span class="login_name_icon"><img src="/public/wap1/images/login02.png"></span>
						<input type="password" name="mima1" placeholder="请输入新密码"  />
					</div>
					<div class="login_name">
						<span class="login_name_icon"><img src="/public/wap1/images/login02.png"></span>
						<input type="password" name="mima2" placeholder="请再次输入新密码"  />
					</div>
