        ...
        <div class="login">
                ...
                <div class="login_con">
                    ...
                    <div class="left">
                        ...
                        <form method="post" name="login" action="<?php echo U('/Index/login','index') ?>" class="loginForm">
                            <dl>
                                <dt>手机号码</dt>
                                <dd>
                        ...
                        <form method="post" name="login" action="<?php echo U('/Index/login_mima','index') ?>" class="loginForm">
                            <dl>
                                <dt>手机号码</dt>
                                <dd>
...
<script>
      function yzm(){
          ...
          if(phone.length!=11){
            ...
            $.post('<?php echo U("Index/yzm") ?>',{'phone':phone},
