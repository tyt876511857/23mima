	...
	<body style="background: #DCF3F9;">
		...
		<section class="ui-container" style="margin-bottom: 40px;">
			...
			<div class="ui-row ui-whitespace">
				...
				<div class="ui-row ui-row-flex ui-whitespace" style="background: #FFFFFF;margin: 10px auto;padding: 10px;"  onclick='window.location.href="<?php echo U("Index/info/id/$v[id]") ?>";'>
					<div class="ui-col ui-col-2">
						...
						<a href='<?php echo U("Index/info/id/$v[id]") ?>' style="display: inline-block;font-size: 1em;width: 100%;text-align:center">·查看状态</a>
					</div>
