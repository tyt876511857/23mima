...
<body>
	...
	<div class="w1000 topnav">
			...
			<div class="right">
				<select><option>您的报告</option></select>
			</div>
	...
	<font style="color:<?php echo $zheye['yichuanglv'][1];?>"><?php if(isset($zheye['title_c'])){echo $zheye['title_c'];} ?>  <?php if(isset($fenshu['description'])){echo $fenshu['description'];} ?></font>
	</p>
	</div>
	<div class="w1000">
		<div class="row">
	...
	<div class="w1000">
		<div class="row">
			...
			<div class="left">
				...
				<?php if ($fenshu1['sum']>=100){?>
					<?php if(isset($zheye['content1'])){echo $zheye['content1'];} ?>
				<?php }else if($fenshu1['sum']>=50){?>
					<?php if(isset($zheye['content2'])){echo $zheye['content2'];} ?>
				<?php }else if($fenshu1['sum']>=0){?>
