...
<body>
	...
	<div class="w1000">
		<div class="row">
			...
			<div class="ck">
					<a href="/user/Index/fit_z/id/<?php echo $id; ?>" target="_blank">检测结果解释</a><a class="ck_btn" href="javascript:;">参考文献</a>
			</div>
		</div>
	</div>
	<div class="w1000">
	...
	<div style="background:#f2f3f4">
		<div class="w1000 overflow">
			...
			<?php foreach ($fit2 as $k=>$v){ ?>
				<a class="item" href="/user/Index/baogao1/id/<?php echo $id; ?>/key/<?php if(isset($v['id'])){echo $v['id'];} ?>/f/<?php if(isset($v['fs'])){echo $v['fs'];} ?>">
